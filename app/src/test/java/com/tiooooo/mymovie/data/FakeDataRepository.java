...
public class FakeDataRepository implements MovieDataSource {
    ...
    private FakeDataRepository(@NonNull ApiCall apiCall, @NonNull LocalDataSource localDataSource, AppExecutors appExecutors) {
        this.apiCall = apiCall;
        this.localDataSource = localDataSource;
        this.appExecutors = appExecutors;
    }

    public static FakeDataRepository getInstance(ApiCall apiCall, LocalDataSource localDataSource, AppExecutors appExecutors) {
        if (INSTANCE == null) {
            synchronized (FakeDataRepository.class) {
                if (INSTANCE == null) {
                    INSTANCE = new FakeDataRepository(apiCall, localDataSource, appExecutors);
                }
            }
        }
        return INSTANCE;
